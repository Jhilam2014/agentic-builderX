...
function agentProfile(node) {
  ...
  if (haystack.includes("ocr") || haystack.includes("image text") || haystack.includes("vision")) return { icon: "🔎", label: "OCR / Vision" };
  if (haystack.includes("signal") || haystack.includes("rtt") || haystack.includes("metric")) return { icon: "📡", label: "Signal analysis" };
  if (haystack.includes("reply") || haystack.includes("whatsapp") || haystack.includes("message")) return { icon: "💬", label: "Reply automation" };
  if (haystack.includes("review") || haystack.includes("validation") || haystack.includes("quality")) return { icon: "💎", label: "Reviewer" };
  if (haystack.includes("execution")) return { icon: "🛠️", label: "Execution" };
  if ((haystack.includes("map") || haystack.includes("geo") || haystack.includes("location")) && haystack.includes("orchestrator")) return { icon: "🧭", label: "Geo orchestrator" };
  if ((haystack.includes("commerce") || haystack.includes("catalog")) && haystack.includes("orchestrator")) return { icon: "🛒", label: "Commerce orchestrator" };
  if (haystack.includes("orchestrator")) return { icon: "🎛️", label: "Orchestrator" };
  ...
  if ((haystack.includes("map") || haystack.includes("geo") || haystack.includes("location")) && haystack.includes("data")) return { icon: "🗺️", label: "Geo data" };
  if (haystack.includes("content")) return { icon: "📝", label: "Content" };
  if (haystack.includes("data")) return { icon: "🗄️", label: "Data" };
